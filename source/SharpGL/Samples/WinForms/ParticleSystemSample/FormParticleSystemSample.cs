...
namespace ParticleSystemSample
{
    public partial class FormParticleSystemSample : Form
    {
        ...
        private uint loop;				// Misc Loop Variable
        private Texture particleTexture;
        private uint[] texture = new uint[1];			// Storage For Our Particle Texture
        ...
        private Particle[] particles = new Particle[1000];			// Particle Array (Room For Particle Info)
